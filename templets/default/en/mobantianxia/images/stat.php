...
var cnzz_data='&r='+escape(cnzz_ref.substr(0,512))+'&lg='+escape(navigator.systemLanguage)+'&ntime=0.48141700 1288417496';
var cnzz_a=gc_cnzz("cnzz_a1554895");
...
var cnzz_sin = gc_cnzz("sin1554895");
if(cnzz_sin==-1) cnzz_sin='none';
if( cnzz_ref.split('/')[2]!=document.domain ) cnzz_sin=cnzz_ref;
var cnzz_eid=gc_cnzz("cnzz_eid");
if(cnzz_eid==-1) cnzz_eid=Math.floor(Math.random()*100000000)+"-"+1288417496+"-"+cnzz_ref.substr(0,64);
...
document.write('<a href="http://www.cnzz.com/stat/website.php?web_id=1554895" target=_blank title="&#31449;&#38271;&#32479;&#35745;">&#31449;&#38271;&#32479;&#35745;</a>');
document.write('<img src="http://zs5.cnzz.com/stat.htm?id=1554895'+cnzz_data+'" border=0 width=0 height=0 />');
...
document.cookie="cnzz_a1554895="+cnzz_a+";expires="+cnzz_ed.toGMTString()+ "; path=/";
document.cookie="sin1554895="+escape(cnzz_sin)+ ";expires="+cnzz_ed.toGMTString()+";path=/";
